...
ALTER TABLE "${opt.schema}".stops ADD COLUMN stop_loc_geom geometry;
UPDATE "${opt.schema}".stops
SET stop_loc_geom = stop_loc::geometry;
ALTER TABLE "${opt.schema}".stops DROP COLUMN stop_loc;
ALTER TABLE "${opt.schema}".stops RENAME COLUMN stop_loc_geom TO stop_loc;
